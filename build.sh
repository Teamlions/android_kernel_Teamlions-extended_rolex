...
# Heading
echo -e "${WHITE}#######################################################${NC}"
echo -e "${WHITE}##### Teamlions-Extended Kernel - Build Script ########${NC}"
echo -e "${WHITE}#######################################################${NC}"
...
# Toolchain
echo -e "${GREEN}Clone Linaro arm64 toolchain if you don,t have${NC} "
...
echo -e "\n\n> ${GREEN}Packing Teamlions-Extended Kernel v$KERNEL_VERSION\n\n${NC}"
